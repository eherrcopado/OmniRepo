...
import { OMNIDEF } from './docGenQuoteEnglish_def.js';
import tmpl from './docGenQuoteEnglish.html';
import tmpl_nds from './docGenQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class docGenQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
